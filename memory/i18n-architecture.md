...
description: How localization (English / Arabic / Moroccan Darija) works in the Barakah app
metadata:
  type: project
---

The app supports 3 locales: `en` (LTR), `ar` (MSA, RTL), `ary` (Moroccan Darija in Arabic script, RTL). Locale code for Darija is the ISO 639-3 `ary`.
